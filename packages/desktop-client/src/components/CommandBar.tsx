...
// BalanceRow component removed for white-label version (uses CellValue/CellValueText)
...
export function CommandBar() {
  ...
  // Accounts and reports removed for white-label version
  ...
  return (
    ...
    >
      <Command.Input
        autoFocus
        placeholder={t('Search {{fileName}}...', { fileName })}
        value={search}
