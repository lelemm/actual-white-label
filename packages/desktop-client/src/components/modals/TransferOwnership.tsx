...
// Budget type removed in white-label version
...
import { closeAndLoadFile } from '@desktop-client/files/filesSlice';
          ...
          >
            ...
            <Button
              ...
              onPress={async () => {
                ...
                try {
                  await onSave();
                  if (currentFile && 'id' in currentFile) {
                    await dispatch(
                      closeAndLoadFile({ fileId: currentFile.id }),
                    );
                  }
                  close();
                } catch {
