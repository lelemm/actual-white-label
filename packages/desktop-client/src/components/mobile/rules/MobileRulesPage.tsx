...
import { ruleToString, type FilterData } from '@desktop-client/components/ManageRules';
...
export function MobileRulesPage() {
  ...
  // White-label version: no budget-specific entities
  ...
  }, [visibleRules, filter, filterData]);
