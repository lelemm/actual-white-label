...
export class MobileNavigation {
  ...
  // White-label version: Budget-specific navigation methods removed
  // Removed: goToBudgetPage, goToAccountsPage, goToUncategorizedPage,
  // goToTransactionEntryPage, goToReportsPage, goToPayeesPage,
  // goToSchedulesPage, goToRulesPage, goToBankSyncPage
