...
// White-label version: Date conversion utilities
function toDateRepr(date: string): string {
  return date;
}

function fromDateRepr(dateRepr: string): string {
  return dateRepr;
}
...
// White-label version: Date conversion utilities exported directly
export { toDateRepr, fromDateRepr };
...
// White-label version: Budget-specific functions removed
// Removed: getCategories, getCategoriesGrouped, insertCategoryGroup, updateCategoryGroup,
// moveCategoryGroup, deleteCategoryGroup, insertCategory, updateCategory, moveCategory,
// deleteCategory, getCategory, getPayee, insertPayee, deletePayee, deleteTransferPayee,
// updatePayee, mergePayees, getPayees, getCommonPayees, syncGetOrphanedPayees,
// getOrphanedPayees, getPayeeByName, getAccount, getAccounts, insertAccount, updateAccount,
// deleteAccount, moveAccount, getTransaction, getTransactions, insertTransaction,
// updateTransaction, deleteTransaction, getTags, getAllTags, insertTag, deleteTag,
// updateTag, findTags
