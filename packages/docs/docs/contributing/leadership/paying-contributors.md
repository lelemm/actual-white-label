...
Points are automatically calculated for all **public members of the Actual White Label organization** through our [GitHub workflow](https://github.com/actualbudget/actual/blob/master/.github/scripts/count-points.mjs). Refer to the workflow documentation for the current point values assigned to different contributor actions.
