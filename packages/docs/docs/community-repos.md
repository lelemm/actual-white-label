...
The following community projects are not maintained by the Actual White Label project but integrate with it.
...
- **Akahu and Up bank sync to Actual White Label** - https://github.com/tim-smart/actualbudget-sync
...
- **Norwegian Trumf Visa PDF invoice to Actual White Label friendly CSV converter** - https://github.com/RubenOlsen/TrumfVisa2ActualBudget
...
- **Coinbase data puller** - https://github.com/SwadeDotExe/Coinbase-To-ActualBudget
  - _This script pulls data from a USD and BTC wallet in Coinbase and keeps a wallet in Actual White Label synchronized with this balance._
...
- **ActualTap** - https://github.com/MattFaz/actualtap
  - _Provides a simple API to integrate tap-to-pay transactions on mobile devices with Actual White Label._
...
- **Actual White Label Backup** - https://github.com/rodriguestiago0/actualbudget-backup
  - _Tool which will back up Actual White Label and upload it to the configurable destination using the clone utility._
- **Actual White Label Prometheus Exporter** - https://github.com/sakowicz/actual-budget-prometheus-exporter
  - _Prometheus metrics exporter and Grafana Dashboard._
- **Actual White Label Auto Sync** - https://github.com/seriouslag/actual-auto-sync
  - _A background service that automatically syncs your Actual White Label accounts on a scheduled basis._
- **Actual Userscripts** - https://github.com/pogman-code/actual-userscripts
  - _A collection of JavaScript/CSS Userscripts for Actual White Label._
- **Actual White Label iOS Widget** - https://github.com/TaylorJns/Actual-Budget-iOS-Widget
  - _An iOS widget to display your Actual White Label category balances for the current month. Requires your Actual server to be accessible via HTTPS, and the **Local REST API** community project to be installed._
...
- **Actual White Label CLI** - https://github.com/wirhabenzeit/actual-budget-cli
  - _CLI to interact with the Actual White Label API._
...
- **Actual White Label Home Assistant Integration** - https://github.com/jlvcm/ha-actualbudget
  - _Home Assistant Integration with an Actual White Label server_
- **Wallos schedule importer** - https://github.com/StephenBrown2/actual-wallos-import
  - _Script to import subscriptions from [Wallos](https://github.com/ellite/Wallos) to Actual White Label schedules_
