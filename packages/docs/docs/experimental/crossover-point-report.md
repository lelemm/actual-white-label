...
| ------------------------------- | ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Expense Categories**          | Specify which Actual White Label categories are expenses that will continue beyond retirement | Used to project expenses into the future to determine when passive income will cover living expenses.<br/>Exclude categories that won't persist beyond financial independence (e.g., retirement savings contributions, work-related expenses).                                                                                                                                                            |
